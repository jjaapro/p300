"""Emits findings.md for the Track V4 audit. Run once; not part of the analysis."""
from pathlib import Path

TEXT = r"""STATUS: CONCLUDED AUDIT per pre-registration
...
Path(__file__).resolve().parent.joinpath("findings.md").write_text(
    TEXT, encoding="utf-8")
