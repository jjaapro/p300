...
Same skeleton as bots/chento_v3: one process, one strategy, one variant
(`bot_short_squeeze_v1`); the existing sleeve package is imported
unchanged. Bot-side additions:

  - fixed-R sizing        1% risk over the sleeve's swept-low stop, with a
                          3× notional cap that binds often by design
  ...
  - scheduled-exit backstop, heartbeat, SSQ_DIAG permanently on
